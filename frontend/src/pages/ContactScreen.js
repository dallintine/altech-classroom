      ...
      <div class="container mx-auto my-4 px-4 lg:px-20">
        <div class="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
          ...
          <div class="my-2 w-1/2 lg:w-1/4">
            <button
              class="uppercase text-sm font-bold tracking-wide bg-green text-gray-100 p-3 rounded-lg w-full 
        ...
        <div class="w-full lg:-mt-96 lg:w-2/6 px-8 py-12 ml-auto bg-blue rounded-2xl">
          <div class="flex flex-col text-white">
            ...
            <div class="flex my-4 w-2/3 lg:w-1/2">
              ...
              <div class="flex flex-col">
                ...
                <p class="text-gray-400">
                  5555 EdInfoHub RD, Pleasant Grove, SB 4536345
                </p>
              </div>
            </div>
